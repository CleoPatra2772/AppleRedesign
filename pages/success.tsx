...
const Success = ({ products} : Props) => {
    ...
    const showOrderSummaryCondition = isTabletOrMobile ? showOrderSummary 
    : true;
        ...
        <div>
            ...
            <main className="grid grid-cols-1 lg:grid-cols-9">
                <section className="order-2 mx-auto max-w-xl pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
                    <Link href="/">
                        <div className="relative ml-14 hidden h-24 w-12 cursor-pointer transition 
                        lg:inline-flex">
                            <Image
                            src="https://rb.gy/vsvv2o"
                            layout='fill'
                    ...
                    <div className="my-8 ml-4 flex space-x-4 lg:ml-14 xl:ml-0">
                        <div className="flex h-11 w-11 items-center jusfity-center rounded-full
                        ...
                        <div>
                            ...
                            <h4 className="text-lg">
                                Thank you{" "}
                                {/* {session_id ? session.user?.name?.split(" ")[0]: "Guest"} */}
                            </h4>
                        </div>
                    </div>
                        ...
                        <div className="mx-4 divide-y divide-gray-300 rounded-md border border-gray-300 p-4 lg:ml-14">
                            <div className="space-y-2 pb-3">
                                ...
                                We've accepted your order, and we're getting it ready. Come back to this page for updates on you shipment status. </p>
                            </div>
                    ...
                    text-sm lg:ml-14 lg:flex-row">
                        ...
                        {mounted && (
                            <section className="overflow-y-scroll border-y border-l border-gray-300 bg-[#FAFAFA] lg:order-2 lg:col-span-4 lg:h-screen
                            lg:border-y-0">
                                <div className={`w-full ${showOrderSummaryCondition && "border-b"} border-gray-300 text-sm lg:hidden`}>
                                    <div className="mx-auto flex max-w-xl items-center justify-between px-4 py-6">
                                        ...
                                        <p className="text-wl font-medium text-black">
                                            ${subtotal + 20}
                                        </p>
                                    </div>
                                </div>
                                {showOrderSummaryCondition && (
                                    <div className="mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0 lg:max-w-lg lg:px-10 lg:py-16">
                                        ...
                                        <div className="space-y-1 py-4">
                                            ...
                                            <div className="flex jusfity-between text-sm">
